...
An individual \verb|xAOD::ExampleElectron| object only has a few parameters for sake of testing, its transvese momentum, \verb|pt|, and its charge, \verb|charge|.
A collection of \verb|xAOD::ExampleElectron| objects are stored in the \verb|xAOD::ExampleElectronContainer| object, which is just a \verb|DataVector| of \verb|xAOD::ExampleElectron| objects.
