...
This thesis also addresses a project to add a handful of I/O unit tests that exercise features exclusive to the xAOD Event Data Model (EDM) such as writing and reading object data from the previous EDM using transient and persistent data. 
...
% -- 
\chapter{Conclusion}
\input{6. Conclusion/_6.Conclusion.tex}
%---
