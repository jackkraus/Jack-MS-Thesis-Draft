...
The Muon Spectrometer (MS) sits at the end of the ATLAS detector and is designed to identify muon tracks and momentum to high-resolution.
...
Monitored Drift Tube (MDT) chambers are used for precision measurement of muon tracks in the principle bending direction of the magnetic fields.
MDTs are placed over the barrel region which extends up to $|\eta|\approx 1$, where the the tubes run perpendicular to the beam and in-line with the magnetic field lines.
The MDT lie in the endcaps pseudorapidity regions $|\eta| > 2.7$, 
