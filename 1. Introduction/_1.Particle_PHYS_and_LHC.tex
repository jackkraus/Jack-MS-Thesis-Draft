...
The HL-LHC era is projected to demand anywhere from 6-10 times as much yearly storage, so any attempt to save on disk storage will help. \cite{ATLAS_HL-LHC_projections}

% What are some areas of research being done to 
% RNTuple
